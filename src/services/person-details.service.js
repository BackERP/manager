...
const SERVICE_API = API_URL + 'person/persondetails/';

class PersonDetailService {

  async getList(person) {
    return ApiProvider.get(SERVICE_API + 'list', { params:{page:-1, person:person}}, { headers: authHeader() });
  }
...
export default new PersonDetailService();
